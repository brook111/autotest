...
public class LoginPageHelper {
		...
		public static void waitLoginPageLoad(SeleniumUtil seleniumUtil,int timeOut){
			...
			seleniumUtil.waitForElementToLoad(timeOut, LoginHaoPage.LP_INPUT_USERNAME);
//			seleniumUtil.waitForElementToLoad(timeOut, LoginHaoPage.LP_INPUT_PASSWORD);
//			seleniumUtil.waitForElementToLoad(timeOut, LoginHaoPage.LP_BUTTON_LOGIN);
		...
		public static void typeLoginInfo(SeleniumUtil seleniumUtil,String username,String password){
			...
			//清空用户名输入框
			seleniumUtil.clear(LoginHaoPage.LP_INPUT_USERNAME);
			//输入用户名到用户名输入框
			seleniumUtil.type(LoginHaoPage.LP_INPUT_USERNAME,username);
			//清空密码输入框
			seleniumUtil.clear(LoginHaoPage.LP_INPUT_PASSWORD);
			//输入密码到密码输入框
			seleniumUtil.type(LoginHaoPage.LP_INPUT_PASSWORD, password);
			logger.info("输入登录信息完毕");
			//点击登录按钮
			seleniumUtil.click(LoginHaoPage.LP_BUTTON_LOGIN);
